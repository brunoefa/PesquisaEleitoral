			...
			<div class="row">
				...
				<div class="col-md-2">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="input-numero" placeholder="XX">
					</div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
						<label for="input-partido">Partido</label>
						<select class="form-control" id="input-partido">
							<option>PDT</option>
							<option>PT</option>
							<option>DEM</option>
							<option>PCdoB</option>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<select class="form-control" id="input-partido" id="input-cargo">
